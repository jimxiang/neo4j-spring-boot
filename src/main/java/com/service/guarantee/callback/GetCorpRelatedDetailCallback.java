...
public class GetCorpRelatedDetailCallback implements Callable<ResultEntity> {
    ...
    public GetCorpRelatedDetailCallback(GuaranteeService guaranteeService, GuaranteeApps guaranteeApps,
                                  Neo4jDAO neo4jDAO, RequestGetCorpRelatedDetail requestData) {
        super();
    ...
    public ResultEntity call() throws Exception {
        return guaranteeService.getCorpRelatedDetail(guaranteeApps, neo4jDAO, requestData);
    }
}
